...
import 'package:test_app_for_eclipse_ds/infrastructure/repositories/photo_repositories/photo_repository.dart';
...
class AlbumDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<PhotoBloc>(
      create: (context) =>
          PhotoBloc(PhotoRepository(PhotosDataProvider()))..add(LoadPhotos(albumId)),
